...
Ext.define('Shopware.apps.sKUZOOffer.view.list.Offer', {
    ...
    totalColumn: function(value, metaData, record) {
        return Ext.util.Format.number(record.get('discountAmount')+record.get('invoiceShipping'),'0.00');
    },
...
*/
        ...
        if(record.raw.offerBilling) {
            billing = record.raw.offerBilling;

            if(billing.company.length > 0) {
